...
<!--                                 <span>Become a <strong>Sponsor</strong></span> -->
    ...
    <div class="section full-width-portfolio" style="border-top:0; border-bottom:0; background:#fff;">
        ...
        <p class="text-center">This year jPrime has its official Android App!<br/>
            <a href='https://play.google.com/store/apps/details?id=com.bgjug.jprime2016&utm_source=global_co&utm_medium=prtnr&utm_content=Mar2515&utm_campaign=PartBadge&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'><img alt='Get it on Google Play' src='https://play.google.com/intl/en_us/badges/images/generic/en_badge_web_generic.png'/></a>
        </p>
