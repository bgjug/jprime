...
<footer>
    <div class="container">
        ...
        --%>
            ...
            <div class="copyright-section">
                <div class="row">
                    <div class="col-md-6">
                        <p>&copy; 2015 <a href="http://jprime.io">jPrime</a> - All Rights Reserved </p>
                    </div>
                    <!-- .col-md-6 -->
                    <div class="col-md-6">
                        <%-- <ul class="footer-nav">
    ...
    <noscript><p><img src="//analytics.sty.bz/piwik.php?idsite=19" style="border:0;" alt="" /></p></noscript>
    <!-- End Piwik Code -->
