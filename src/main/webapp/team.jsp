                    ...
                    <div class="team-overlay">
                        <div class="overlay-social-icon text-center">
                            <ul class="social-icons">
                                <li><a href="https://x.com/ivan_stefanov"><i class="fa-brands fa-x" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="team-item text-center">
                <div class="team-img">
                    ...
                    <div class="team-overlay">
                        <div class="overlay-social-icon text-center">
                            <ul class="social-icons">
                                <li><a href="https://x.com/bercut2000"><i class="fa-brands fa-x" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="team-item text-center">
                <div class="team-img">
                    ...
                    <div class="team-overlay">
                        <div class="overlay-social-icon text-center">
                            <ul class="social-icons">
                                <li><a href="https://x.com/gochev"><i class="fa-brands fa-x" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="team-item text-center">
                <div class="team-img">
                    ...
                    <div class="team-overlay">
                        <div class="overlay-social-icon text-center">
                            <ul class="social-icons">
                                <li><a href="https://x.com/dbondzhev"><i class="fa-brands fa-x" aria-hidden="true"></i></a></li>
                                <li><a href="https://bsky.app/profile/dbondzhev.bsky.social"><i class="fa-brands fa-bluesky" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
