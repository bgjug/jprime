        ...
        <c:forEach var="submission" items="${submissions}">
            <tr>
                ...
                <td rowspan="3" class="title-column">
                    <a href="/admin/submission/accept/${submission.id}">Accept</a>&nbsp;|&nbsp;<a
                        href="/admin/submission/confirm/${submission.id}">Confirm</a> | <a
                        href="/admin/submission/reject/${submission.id}">Reject</a><br/>
                    <a href="/admin/submission/edit/${submission.id}">Edit</a>&nbsp;|&nbsp;<a
