        ...
        <div class="row">
            <div class="col-12">
                <p>
                    ...
                    <p>* The <strong>early bird ticket</strong> price for the conference is <strong>140</strong>.00 BGN (VAT included) until 1st of July.</p>
                    <p>* The <strong>regular</strong> ticket price after 1st of July will be <strong>200</strong>.00 BGN (VAT included).</p>
