        ...
        <div class="row">
            <div class="col-12">
                <p>
                    ...
                    <p>* The <strong>early bird ticket</strong> price for the conference is <strong>${early_bird_ticket_price}</strong> EUR (VAT included) until ${cfp_close_date}.</p>
                    <p>* The <strong>regular</strong> ticket price after ${cfp_close_date_no_year} will be <strong>${regular_ticket_price}</strong> EUR (VAT included).</p>
                    <p>* There is a discount of the regular ticket price for students. Student ticket price is <strong>${student_ticket_price}</strong> EUR (VAT included).</p>
