        ...
        <div class="row">
            <div class="col-12">
                <p>
                    ...
                    <p>* The <strong>early bird ticket</strong> price for the conference is <strong>180</strong>.00 BGN (VAT included) until 15th of February 2023.</p>
                    <p>* The <strong>regular</strong> ticket price after 1st of March will be <strong>280</strong>.00 BGN (VAT included).</p>
