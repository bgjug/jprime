...
@Repository(value = RegistrantInvoiceNumberGeneratorRepository.NAME)
public interface RegistrantInvoiceNumberGeneratorRepository extends PagingAndSortingRepository<Registrant.InvoiceNumberGenerator, Long> {

	String NAME = "registrantInvoiceNumberGeneratorRepository";
...
//    Page<Article> findAllPublishedArticles(Pageable pageable);
    ...
    Registrant.InvoiceNumberGenerator findFirstByOrderByIdAsc();
}
