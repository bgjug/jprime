 ...
 * Tests invoice data form display.
 */
...
class AdminInvoiceControllerTest {
    ...
    @Test
    void getInvoiceDataForm_shouldReturnInvoiceDataForm() throws Exception {
        mockMvc.perform(get("/admin/invoice/" + testRegistrant.getId()))
